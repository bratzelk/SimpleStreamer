...
/*
 * SyncTest is a test class. It is not a client/server program. Both the sender and receiver are
 * maintained locally. Two file names should be given as arguments: fromFile and toFile. SyncTest
 * will call the synchroniser every 5 seconds to copy changes from fromFile to toFile.
 */
